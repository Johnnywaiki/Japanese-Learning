...
function makeStyles(isDark: boolean) {
  ...
  const s = StyleSheet.create({
    ...
    levelHeaderWrap: { position: 'relative' }, // 讓 dropdown 可以絕對定位
    levelHeader: {
      flexDirection: 'row',
      alignItems: 'center',
...
export default function HomeScreen() {
  ...
  return (
    <RNScrollView
      ...
      nestedScrollEnabled
    >
      {/* 只顯示當前 Level（由最初頁選擇） + 下拉選單 */}
      <RNView style={s.levelHeaderWrap}>
