...
function makeStyles(isDark: boolean) {
  ...
  const s = StyleSheet.create({
    ...
    wrap: { flexGrow: 1, padding: 16, gap: 16, overflow: 'visible' }, // 重要：容許下拉超出

    /** ===== Level Header + Dropdown（提高層級） ===== */
    levelHeaderStack: {
      position: 'relative',
      zIndex: 1000,        // iOS
      elevation: 1000,     // Android（配合有陰影/背景嘅子元素）
    },
    levelHeader: {
      flexDirection: 'row',
      alignItems: 'center',
...
export default function HomeScreen() {
  ...
  return (
    <RNScrollView
      ...
      nestedScrollEnabled
    >
      {/* Level Header + Dropdown（整個 stack 提到最前） */}
