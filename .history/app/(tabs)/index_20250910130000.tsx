...
export default function PracticeFilterScreen() {
  // 預設：程序=N2–N3隨機；年份=隨機；月份=隨機；類型=言語知識
...
const s = StyleSheet.create({
  ...
  boxHeaderText: { fontSize: 14, fontWeight: '600' },
  box: { padding: 10, borderWidth: 1, borderColor: '#eee', borderRadius: 12, backgroundColor: '#fff', gap: 6 },

  pill: {
    paddingVertical: 8, paddingHorizontal: 14, borderRadius: 999, borderWidth: 1, borderColor: '#ddd',
    backgroundColor: '#fff',
  },
  pillSm: {
    paddingVertical: 6, paddingHorizontal: 10, borderRadius: 999, borderWidth: 1, borderColor: '#ddd',
    backgroundColor: '#fff',
  },
  ...
  next: { padding: 14, borderRadius: 12, backgroundColor: '#111' },
