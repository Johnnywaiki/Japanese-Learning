...
// 以 icon 取代原本的 7 個文字
const ICONS = [
  { lib: 'mci', name: 'flower-outline' },      // MaterialCommunityIcons
  { lib: 'mci', name: 'noodles' },     // MaterialCommunityIcons
  { lib: 'fa5', name: 'fan' },         // FontAwesome5
  { lib: 'fa5', name: 'torii-gate' },  // FontAwesome5
  { lib: 'mci', name: 'rice' },        // MaterialCommunityIcons
  { lib: 'mci', name: 'ninja' },       // MaterialCommunityIcons
  { lib: 'mci', name: 'wave' },        // MaterialCommunityIcons
] as const;
