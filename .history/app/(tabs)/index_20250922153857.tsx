...
// 🔻 不再此處 init，所以刪走 useQuiz / PracticeFilter import
...
export default function PracticeFilterScreen() {
  ...
  const onStartPress = () => {
    ...
    // 🔻 改動重點：唔喺呢度 init；帶 filter 參數去 practice-exam
    // kind: 把 UI 的合併選項映射到 store 需要的 'language' 或 'listening'
    const params: Record<string, string> = {
      level: String(level === 'daily' ? 'N2-N3-random' : level), // 如果選 daily，就用原來既 default pool
