  ...
  if (error) {
    return (
      <View style={s.wrap}>
        ...
        <Link href="/(tabs)/two" style={s.linkBtn}><Text style={s.linkBtnText}>去設定</Text></Link>
...
const s = StyleSheet.create({
  ...
  linkBtn: { paddingVertical: 10, paddingHorizontal: 14, borderRadius: 10, borderWidth: 1, borderColor: '#888', alignSelf: 'flex-start' },
