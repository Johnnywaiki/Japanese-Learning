...
import type { Topic } from '../../src/db'; // ✅ 從入口檔取 type（避免 schema 路徑問題）
...
export default function PracticeFilterScreen() {  // ✅ default export 在度
  ...
  const onStartPress = () => {
    ...
    // 🚀 必須帶齊 year + session 去 practice-exam
    router.push({
      ...
      params: {
        ...
        year: String(year),
        session,
        month: session === 'July' ? '07' : '12', // 額外帶明確 month，避免任何推斷差異
      },
    });
  };
